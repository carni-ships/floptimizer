...
- Before launching a new compute-heavy run on a shared or suspect machine, run [`scripts/resource_gate.sh`](scripts/resource_gate.sh) and obey it. If the gate is not `READY`, pause new heavy work and switch to non-competing analysis until the machine settles.
